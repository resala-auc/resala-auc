...
const successProcessing = document.querySelector             ("[data-success-processing]");
...
const selectedRoleDetailsButton = document.querySelector                   ("[data-selected-role-details]");
const roleDetailsDialog = document.querySelector             ("[data-role-details-dialog]");
const roleDetailsPanel = document.querySelector             (".role-details-panel");
const roleDetailsContent = document.querySelector             ("[data-role-details-content]");
...
document.addEventListener("click", (event) => {
  const detailsButton = event.target instanceof Element ? event.target.closest             ("[data-role-details]") : null;
  if (detailsButton) {
